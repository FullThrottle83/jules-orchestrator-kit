/**
 * Swarm branch merger with 3-way structural JSON/object merge, git merge-file
 * execution isolated in os.tmpdir(), and safety gate checking.
 *
 * This is the home of the logic that used to live in
 * `scripts/jules-merge-swarm.mjs`; that file is now a minimal CLI entry point.
 */
