...
export const COMMAND_REGISTRY = [
  ...
  },
  {
    ...
    path: ["task"],
    title: "task",
    description: "Manage task envelopes: create, template, optimize, or validate (see task create | task template | task optimize | task validate)",
    category: "Create",
    mutates: true,
    risk: "moderate",
  ...
  },
  {
    ...
    path: ["task", "validate"],
    title: "task validate",
    description: "Validate a task envelope markdown or JSON file without dispatching",
    category: "Inspect",
    mutates: false,
    risk: "low",
    interactive: "never",
    ...
    flags: [
      { name: "json", type: "boolean", description: "Output machine-readable validation result" },
    ],
  },
  {
    id: "init",
    path: ["init"],
    title: "init",
    description: "Write the minimal canonical project config and runtime ignore entries",
    category: "Configure",
    mutates: true,
    risk: "moderate",
    interactive: "optional",
    ...
    flags: [
      ...
      { name: "force", type: "boolean", description: "0.x compatibility: also write the legacy Jules manifest and full scaffold (-f)" },
      { name: "dry-run", type: "boolean", description: "List exact files that would be written without changing the repository (-d)" },
  ...
  },
  {
    ...
    path: ["uninstall"],
    title: "uninstall",
    description: "Remove kit-owned configuration and gitignore entries from the repository",
    category: "Configure",
    mutates: true,
    risk: "low",
    interactive: "never",
    ...
    flags: [
      { name: "dry-run", type: "boolean", description: "Report files that would be removed without modifying disk (-d)" },
      { name: "yes", type: "boolean", description: "Confirm uninstallation without prompting (-y)" },
      { name: "force", type: "boolean", description: "Remove legacy scaffold directories if present (.agent/rules, .agent/prompts, .agent/workflows) (-f)" },
      { name: "json", type: "boolean", description: "Output machine-readable removal plan or outcome (-j)" },
    ],
  },
  {
    id: "migrate",
  ...
  },
  {
    ...
    path: ["lock"],
    title: "lock",
    description: "Multi-agent coordination locks: acquire, release, reap, or view file status",
    category: "Operate",
    mutates: true,
    risk: "low",
    interactive: "never",
    ...
    flags: [
      ...
      { name: "dry-run", type: "boolean", short: "d", description: "Report stale locks without unlinking them" },
      { name: "json", type: "boolean", description: "Output structured JSON result (-j)" },
    ],
  },
  {
